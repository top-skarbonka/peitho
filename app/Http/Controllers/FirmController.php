...
class FirmController extends Controller
{
    ...
    public function storeClientPoints(Request $request)
    {
        ...
        // 🔥 NOWE — TWORZENIE KARTY JEŚLI NIE ISTNIEJE
        $cardExists = DB::table('loyalty_cards')
    ...
    public function scanQr(Request $request)
    {
        ...
        if (!$code) {
            return redirect()->route('company.scan.form')
                ->with('error', 'Niepoprawny kod QR');
        }

        return redirect()->route('company.points.client.form', [
            'phone' => $code
        ]);
    }
}
